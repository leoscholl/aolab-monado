...
\
    _(XRT_INPUT_DTRACK_CONTROLLER_TRIGGER_CLICK        , XRT_INPUT_NAME(0x0F00, VEC1_ZERO_TO_ONE)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_1_CLICK              , XRT_INPUT_NAME(0x0F01, BOOLEAN)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_2_CLICK              , XRT_INPUT_NAME(0x0F02, BOOLEAN)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_3_CLICK              , XRT_INPUT_NAME(0x0F03, BOOLEAN)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_4_CLICK              , XRT_INPUT_NAME(0x0F04, BOOLEAN)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_THUMBSTICK_CLICK     , XRT_INPUT_NAME(0x0F05, BOOLEAN)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_THUMBSTICK           , XRT_INPUT_NAME(0x0F06, VEC2_MINUS_ONE_TO_ONE)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_GRIP_POSE            , XRT_INPUT_NAME(0x0F07, POSE)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_AIM_POSE             , XRT_INPUT_NAME(0x0F08, POSE))
// clang-format on
